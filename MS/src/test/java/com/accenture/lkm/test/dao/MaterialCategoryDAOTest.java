...
public class MaterialCategoryDAOTest {
	...
	public void notNullMaterialCategoryDAOTest() {
		Assert.assertNotNull("Null",materialCategoryDAO);
	...
	public void findByIdMaterialCategoryTest() {
		...
		materialCategoryEntity = materialCategoryDAO.findOne("C001");
		Assert.assertNotNull("Entity is not present with that Id",materialCategoryEntity);
	...
	public void findAllMaterialCategoryTest() {
		// Your Code Here
		Assert.assertNotNull("List is null",materialCategoryDAO.findAll());
		Assert.assertEquals("Count mismatch",3,materialCategoryDAO.count());
